...
exports.getContractorSummary = exports.getOfficerCollections = exports.getMyOfficers = void 0;
 ...
 */
const getMyOfficers = async (req, res, next) => {
    try {
        ...
        return (0, response_1.sendSuccess)(res, officers);
    }
    catch (err) {
        next(err);
    }
};
exports.getMyOfficers = getMyOfficers;
/**
 ...
 */
const getOfficerCollections = async (req, res, next) => {
    try {
        const contractorId = req.user.id;
        let { id } = req.params;
        if (Array.isArray(id))
        ...
        const officer = await prisma_1.prisma.user.findFirst({
            where: { id, contractorId, deletedAt: null },
            select: { id: true, firstName: true, lastName: true, role: true },
        });
        if (!officer) {
            return (0, response_1.sendError)(res, 'Officer not found or does not belong to your team', 'FORBIDDEN', null, 403);
        }
...
exports.getContractorSummary = getContractorSummary;
