 ...
 */
router.get('/permits/verify/:code', business_controller_1.verifyPermit);
// ── BUSINESS PROFILE ──────────────────────────────────────────
/**
 * @openapi
 * /business:
 ...
 */
router.post('/', auth_middleware_1.requireAuth, (0, authorize_middleware_1.requireRole)('business_owner'), (0, validate_middleware_1.validateBody)(business_validation_1.createBusinessSchema), business_controller_1.createBusiness);
/**
 * @openapi
 * /business/my:
 *   get:
 ...
 */
router.get('/my', auth_middleware_1.requireAuth, (0, authorize_middleware_1.requireRole)('business_owner'), business_controller_1.getMyBusiness);
/**
 * @openapi
 * /business/my:
 *   patch:
 ...
 */
router.patch('/my', auth_middleware_1.requireAuth, (0, authorize_middleware_1.requireRole)('business_owner'), (0, validate_middleware_1.validateBody)(business_validation_1.updateBusinessSchema), business_controller_1.updateMyBusiness);
// ── PERMITS ───────────────────────────────────────────────────
/**
 * @openapi
 * /business/permits:
 ...
 */
router.post('/permits', auth_middleware_1.requireAuth, (0, authorize_middleware_1.requireRole)('business_owner'), (0, validate_middleware_1.validateBody)(business_validation_1.applyPermitSchema), business_controller_1.applyForPermit);
/**
 * @openapi
 * /business/permits:
 *   get:
 ...
 *         description: No active business found
 */
router.get('/permits', auth_middleware_1.requireAuth, (0, authorize_middleware_1.requireRole)('business_owner'), business_controller_1.getMyPermits);
/**
 * @openapi
 * /business/permits/{id}:
 *   get:
 ...
 *         description: Permit not found
 */
router.get('/permits/:id', auth_middleware_1.requireAuth, (0, authorize_middleware_1.requireRole)('business_owner'), business_controller_1.getMyPermitById);
/**
 * @openapi
 ...
 *         description: Permit not found
 */
router.post('/permits/:id/renew', auth_middleware_1.requireAuth, (0, authorize_middleware_1.requireRole)('business_owner'), (0, validate_middleware_1.validateBody)(business_validation_1.renewPermitSchema), business_controller_1.renewPermit);
// ── INVOICES ──────────────────────────────────────────────────
/**
 * @openapi
 * /business/invoices:
 ...
 *         description: No active business found
 */
router.get('/invoices', auth_middleware_1.requireAuth, (0, authorize_middleware_1.requireRole)('business_owner'), (0, validate_middleware_1.validateQuery)(business_validation_1.listInvoicesSchema), business_controller_1.getMyInvoices);
/**
 * @openapi
 ...
 */
router.get('/invoices/:id', auth_middleware_1.requireAuth, (0, authorize_middleware_1.requireRole)('business_owner'), business_controller_1.getMyInvoiceById);
