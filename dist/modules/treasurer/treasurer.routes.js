...
const treasurer_controller_1 = require("./treasurer.controller");
const treasurer_validation_1 = require("./treasurer.validation");
...
router.use(auth_middleware_1.requireAuth, (0, role_middleware_1.requireRole)('treasurer', 'super_admin'));
// ============================================================
 ...
 */
router.post('/levy-configs', (0, validate_middleware_1.validateBody)(treasurer_validation_1.createLevyConfigSchema), treasurer_controller_1.createLevyConfig);
/**
 * @openapi
 * /treasurer/levy-configs:
 *   get:
 ...
 *                       type: integer
 */
router.get('/levy-configs', (0, validate_middleware_1.validateQuery)(treasurer_validation_1.listLevyConfigsSchema), treasurer_controller_1.listLevyConfigs);
/**
 * @openapi
 ...
 */
router.get('/levy-configs/:id', treasurer_controller_1.getLevyConfigById);
/**
 * @openapi
 * /treasurer/levy-configs/{id}:
 *   patch:
 ...
 *         description: Levy configuration not found
 */
router.patch('/levy-configs/:id', (0, validate_middleware_1.validateBody)(treasurer_validation_1.updateLevyConfigSchema), treasurer_controller_1.updateLevyConfig);
/**
 * @openapi
 ...
 *         description: Levy configuration not found
 */
router.patch('/levy-configs/:id/toggle', treasurer_controller_1.toggleLevyConfig);
// ============================================================
// REVENUE ANALYTICS
// ============================================================
/**
 ...
 *                       type: array
 */
router.get('/revenue', treasurer_controller_1.getRevenueOverview);
/**
 * @openapi
 ...
 *                             type: integer
 */
router.get('/revenue/by-officer', treasurer_controller_1.getRevenueByOfficer);
/**
 * @openapi
 ...
 *                             type: integer
 */
router.get('/revenue/by-ward', treasurer_controller_1.getRevenueByWard);
// ============================================================
// RECONCILIATION
// ============================================================
/**
 ...
 *                       type: object
 */
router.get('/reconciliation', treasurer_controller_1.getReconciliation);
// ============================================================
 ...
 *                   type: object
 */
router.get('/invoices', treasurer_controller_1.getAllInvoices);
/**
 * @openapi
 ...
 */
router.get('/invoices/:id', treasurer_controller_1.getInvoiceById);
/**
 * @openapi
 ...
 *         description: Invoice not found
 */
router.patch('/invoices/:id/mark-overdue', treasurer_controller_1.markInvoiceOverdue);
